...
export const root = dir('~', [
  ...
  dir('Documents', [
    ...
    dir('Projects', [
      ...
      file('Vellum.md', 'md', { contentUrl: '/content/achievements.md', size: 2200 }),
      file('FPAI.md', 'md', { contentUrl: '/content/portfolio.md', size: 2200 }),
      file('Amadeus 2.0.md', 'md', { contentUrl: '/content/portfolio.md', size: 2200 }),
      file('ContextCLI.md', 'md', { contentUrl: '/content/portfolio.md', size: 1800 }),
      file('owenisas.com.md', 'md', { contentUrl: '/content/portfolio.md', size: 3000 }),
      file('Amadeus.md', 'md', { contentUrl: '/content/portfolio.md', size: 1800 }),
    ]),
    dir('Notes', [
